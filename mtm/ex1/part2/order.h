...
/**
 * copyOrder: copy all the order's fields to a new order.
...
/**
 * freeOrder: free an order and all it's content from memory.
...
/**
 * compareOrders: compare between two orders' IDs.
...
/**
 * changeProductAmountInOrder: change amount of product in order to
...
/**
 * getOrderID: return the order's ID into the id pointer.
...
/**
 * getFirstProductInOrder: get the first product in the order.
...
/**
 * getNextProductInOrder: get the next product in the order.
...
/**
 * calcPrice: total price of all the products in order.
